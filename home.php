...
<body>
  <div class="min-h-screen w-full ">
    <nav class="bg-primary font-cinema shadow-lg sticky top-0 z-50 rounded-b-2xl">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          <!-- Logo section -->
          <div class="flex-shrink-0 overflow-hidden cursor-pointer flex items-center">
            <img onclick="window.location.href='index.php'" class="h-32 w-auto rounded-full" src="./assets/zenstar1.png"
              alt="Logo" />
    ...
    <div class="w-full flex flex-col items-center justify-center relative min-h-screen bg-cover bg-center"
      ...
      <div class="flex flex-col z-10 items-center w-[60%] text-center">
        ...
        <p class="text-zinc-300 mt-7">From leadership and creativity to wisdom and balance—each number reveals a
          different side of you. Calculate your Life Path Number and explore the traits, strengths, and challenges that
          make you unique.</p>
      </div>
