    ...
    <div class="bg-[#70507E] rounded-lg shadow-md p-8 max-w-md w-full">
        ...
        <div class="mb-8 text-zinc-200 space-y-3">
            ...
            <p class="text-xs italic text-pink-200">
                Note: Only DOB is required. Time and place are optional for advanced insights.
            </p>
        </div>
        ...
        <form class="space-y-5" action="planet_traits.php" method="POST">
            ...
            <div>
                <label for="time" class="block text-sm font-medium text-zinc-200 mb-1">Time of Birth <span class="text-pink-200">(Optional)</span></label>
                <input 
                    type="time" 
                    id="time" 
                    name="time"
            ...
            <div>
                <label for="place" class="block text-sm font-medium text-zinc-200 mb-1">Place of Birth <span class="text-pink-200">(Optional)</span></label>
                <input 
                    type="text" 
                    id="place" 
                    name="place"
